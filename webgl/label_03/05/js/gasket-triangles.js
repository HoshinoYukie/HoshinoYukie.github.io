...
function triangle( a, b, c ){
	...
	if( twist == false ){
        ...
        vec3.set( a1, a[0] * Math.cos( d_a * radian ) - a[1] * Math.sin( d_a * radian ), 
            a[0] * Math.sin( d_a * radian ) + a[1] * Math.cos( d_a * radian ), 0 );
        vec3.set( b1, b[0] * Math.cos( d_b * radian ) - b[1] * Math.sin( d_b * radian ),
            b[0] * Math.sin( d_b * radian ) + b[1] * Math.cos( d_b * radian ), 0 );
        vec3.set( c1, c[0] * Math.cos( d_c * radian ) - c[1] * Math.sin( d_c * radian ),
